...
public class EncryptUtils {
     ...
     * 密钥 
     */  
    private static final String KEY = "fiberMonitorSyst";  
    ...
    public static String aesEncrypt(String content, String encryptKey) throws Exception {  
    	encryptKey=encryptKey.isEmpty()?KEY:encryptKey;
     ...
     */  
     public static String aesDecryptByBytes(byte[] encryptBytes, String decryptKey) throws Exception {  
            KeyGenerator kgen = KeyGenerator.getInstance("AES");  
            kgen.init(128);  
            decryptKey=decryptKey.isEmpty()?KEY:decryptKey;
            Cipher cipher = Cipher.getInstance(ALGORITHMSTR);  
    ...
    public static void main(String[] args) throws Exception{
    	...
    	System.out.println(aesEncrypt("abcd@1234"));
    	System.out.println(aesDecrypt(aesEncrypt("abcd@1234")));
    }
}
